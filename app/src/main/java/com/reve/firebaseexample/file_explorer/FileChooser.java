package com.reve.firebaseexample.file_explorer;
...
public class FileChooser extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if((o != null && o.getImage().equalsIgnoreCase("directory_icon")) || (o != null && o.getImage().equalsIgnoreCase("directory_up"))){
